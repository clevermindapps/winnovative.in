...
<p><strong>Skill Sets:</strong> HTML, CSS, Web Technologies, JavaScript, Photoshop<br>
<strong>Role:</strong> Web Designer<br>
<strong>Qualification:</strong> Any Degree<br>
<strong>Experience:</strong> 0 - 2 years<br></p>
</div>
                    <div class="careers_box">
<h4><i class="fa fa-caret-right blue4"></i> Web Developer</h4>
<p><strong>Skill Sets:</strong> HTML, CSS, JavaScript, PHP, jQuery<br>
...
<p><strong>Skill Sets:</strong> Off-page Optimization, SEO Analysis, Google Analytics, Keyword Research, Google AdWords, Social Media Optimization, Search Engine Optimization, Google Webmaster Tools, Search Engine Marketing, SEO, On-page Optimization, Link Building<br>
