        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <p class="mb-4" align="justify">Document Receipt, Inventory Preparation, Document Scanning, Image Processing, Quality Control, Transfer to Repository. Winnovative also offers special digitization services for rare books. We are equipped with high-quality production scanners and a Bookeye over-head scanner. Bookeye is ideal for capturing bound documents – rare books, ancient manuscripts, and archival content. Documents remain in their natural state on the scan surface. They do not need to be unbound, separated, or carefully positioned.</p>


                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="design/newimg/Digitization.jpg" style="object-fit: cover;">
                    </div>
                </div>
